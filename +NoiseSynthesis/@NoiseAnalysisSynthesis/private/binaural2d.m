function [vCohere] = binaural2d(self,dist,vFreqDesired)
...
%
% Usage: [vCohere] = binaural2d(self,dist,vFreqDesired)
%
%
...
if ~dist,
    ...
    vCohere = interp1(vFreq,stData.bin_coh_2d,vFreqDesired,'linear','extrap');
    vCohere = vCohere(:);
end
